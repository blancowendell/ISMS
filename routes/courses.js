...
router.get("/", function (req, res, next) {
  Validator(req, res, "courseslayout");
  //res.render('institutionslayout', { title: 'Express' });
});

module.exports = router;

router.get("/loadcourses", (req, res) => {
  try {
    let sql = `SELECT
    mc_course_id,
    mc_name_code,
    mc_description,
    mi_name as mc_institute_name,
    mc_type,
    mc_term
    FROM master_courses
    INNER JOIN master_institutions ON master_courses.mc_institutionsid = mi_institutionsid`;
